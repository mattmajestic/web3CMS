...
selected_page = st.sidebar.radio("Navigation Panel", page_names_to_funcs.keys(), [f'<span style="font-size: 18px;">{page}</span>' for page in page_names_to_funcs.keys()], unsafe_allow_html=True, index=0)
