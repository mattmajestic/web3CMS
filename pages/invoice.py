...
def home_page():
    ...
    with st.sidebar:
         ...
         buttons.innerHTML = '<img src="https://i0.wp.com/kindalame.com/wp-content/uploads/2021/05/metamask-fox-wordmark-horizontal.png?compress=1&resize=200x150&vertical=top" />';
         </script>
         </body>
         </html>
         <script>
